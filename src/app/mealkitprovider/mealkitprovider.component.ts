...
@Component({
  selector: 'app-mealkitprovider',
  templateUrl: './mealkitprovider.component.html',
  styleUrls: ['./mealkitprovider.component.css']
})
export class MealkitproviderComponent implements OnInit {
  ...
  constructor(private recipeService: RecipeService,
    ...
    this.readyKitDetails = this.formBuilder.group({
    ...
    this.orderDetail =
      {
        ...
        shippingaddress:
        {
          ...
          state: this.readyKitDetails.get('shippingAddressInfo').get('state').value,
        ...
        billingaddress:
        {
          ...
          state: this.readyKitDetails.get('billingAddressInfo').get('state').value,
  ...
  get weekDaysControls(): FormArray {
    return this.readyKitDetails.get('orderFrequency').get('days') as FormArray;
  };
